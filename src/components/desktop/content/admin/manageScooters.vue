  ...
  <div>
    ...
    <div class="centerDiv">
      ...
      <select
        ...
        @click="fetchScooters()"
      >
        <option value="Göteborg" :selectedCity="selectedCity === 'Göteborg'">
          Göteborg
        </option>
        <option value="Uppsala" :selectedCity="selectedCity === 'Uppsala'">
          Uppsala
        </option>
        <option value="Linköping" :selectedCity="selectedCity === 'Linköping'">
          Linköping
        </option>
      </select>
    </div>
      ...
      <tbody>
        <tr v-for="scooter in scootersFilter" :key="scooter._id">
          ...
          <td>
            ...
            <div v-else-if="scooter.city === 'Uppsala'">Uppsala</div>
  ...
  methods: {
    ...
    async fetchScooters() {
      try {
        ...
        const response = await axios.get("http://localhost:3000/v1/scooters/");
        this.scooters = response.data.data;
        this.scooters.filter((scooter) => scooter.city === this.selectedCity);
